...
figure, (voltage,current) = pyplot.subplots(2,1)
voltage.grid(True)
current.grid(True)
...
animation = animation.FuncAnimation(figure, func = animate, frames=np.arange(0, N, (int)(K/10)), interval = 100, repeat = False)
